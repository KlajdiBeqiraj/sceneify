...
export function StatusBar({ status, protocol, revision, selectedId }: { status: string; protocol: { version: number; compatible: boolean }; revision?: number; selectedId: string | null }) {
  return (
    <>
